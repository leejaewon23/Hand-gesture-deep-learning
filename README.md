...
| `주제_3_CNN으로_이미지_분류.ipynb` | CIFAR-100으로 CNN 구조, 필터, 특징 맵, 혼동 행렬을 실험한 참고 노트북입니다. |
...
- `주제_3_CNN으로_이미지_분류.ipynb`: `torchvision.datasets.CIFAR100`
...
1. `주제_3_CNN으로_이미지_분류.ipynb`에서 기본 CNN 구조와 시각화 방법을 확인합니다.
